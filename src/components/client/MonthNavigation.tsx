  ...
  return (
    <div className="flex items-center justify-between mb-6">
      <button
        ...
        className="flex items-center text-brand-primary hover:opacity-80 font-medium transition-colors"
      >
      ...
      <button
        onClick={goToToday}
        className="px-4 py-2 text-sm text-brand-primary hover:bg-brand-primary/5 rounded-lg border border-brand-primary/10 transition-colors"
      >
        Hoje
      </button>
    </div>
