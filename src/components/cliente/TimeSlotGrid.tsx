            ...
            <button
              ...
              className={cn(
                ...
                isSelected
                  ...
                  : isAvailable
                  ? 'bg-white text-brand-text border border-brand-soft hover:border-brand-primary hover:bg-brand-primary/5'
            ...
            >
              <div className="flex flex-col items-center justify-center">
                ...
                {slot.label && !isSelected && (
                  <span className="absolute -top-1.5 -right-1.5 px-1.5 py-0.5 rounded-full bg-brand-secondary text-[7px] font-black text-brand-accent shadow-sm transform rotate-12">
                     {slot.label}
                  </span>
                )}
              </div>
