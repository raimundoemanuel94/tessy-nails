...
function getAdminApp(): admin.app.App {
  ...
  const clientEmail = process.env.FIREBASE_CLIENT_EMAIL ?? "firebase-adminsdk-fbsvc@nailit-792a7.iam.gserviceaccount.com";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ success: errors.length === 0, created, skipped, total: SERVICES.length, tessyUid: TESSY_UID, errors });
  } catch (e) {
