...
export default function ClientePage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#FFFDFE] pb-28">
      ...
      <main className="relative mx-auto max-w-[430px] space-y-6 px-5 pt-5">
        <section>
          <Button
            className="h-[74px] w-full justify-between rounded-[30px] border border-[#E9DDF7] bg-linear-to-r from-[#7C3AED] to-[#F472B6] px-5 text-white shadow-[0_20px_40px_-22px_rgba(124,58,237,0.45)] transition hover:opacity-95 active:scale-[0.99]"
          ...
          <div className="grid grid-cols-2 gap-3">
            {quickActions.map((item) => (
              <button
                key={item.id}
                onClick={item.action}
                className="rounded-[28px] border border-[#E9DDF7] bg-white p-4 text-left shadow-[0_18px_45px_-36px_rgba(31,23,42,0.22)] transition hover:-translate-y-0.5 hover:shadow-[0_24px_50px_-36px_rgba(124,58,237,0.22)] active:scale-[0.99]"
              >
          ...
          <div className="grid gap-3">
            {services.slice(0, 3).map((service, index) => {
              ...
              return (
                <button
                  key={service.id}
                  className="group flex items-center justify-between rounded-[28px] border border-[#E9DDF7] bg-white p-4 text-left shadow-[0_18px_45px_-36px_rgba(31,23,42,0.2)] transition hover:-translate-y-0.5 hover:shadow-[0_24px_50px_-36px_rgba(124,58,237,0.22)] active:scale-[0.99]"
