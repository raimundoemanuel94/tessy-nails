...
const templates = [
  {
    ...
    message: "Oi, {cliente}! Passando para lembrar do seu horário amanhã às {hora} no {salao}.",
    tone: "brand",
  },
  {
    icon: RotateCcw,
    ...
    message: "Oi, {cliente}! Já está na hora de cuidar das unhas de novo? Agende seu retorno pelo link do {salao}.",
    tone: "warning",
  },
  {
    icon: Cake,
    ...
    message: "Feliz aniversário, {cliente}! O {salao} preparou um carinho especial para você.",
    tone: "success",
  },
  {
    icon: Sparkles,
    ...
    message: "Novos horários disponíveis no {salao}. Clique no link e garanta seu atendimento.",
    tone: "default",
  },
];
