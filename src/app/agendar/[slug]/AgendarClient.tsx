...
type Settings = {
  ...
  working_hours: Record<string, { is_open?: boolean; open?: string; close?: string; intervals?: Array<{ open: string; close: string }> }>
...
function isFeaturedService(service: Service) {
